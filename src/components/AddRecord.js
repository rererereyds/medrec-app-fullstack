...
const AddRecord = () => {
  ...
  const submitRecord = () => {
    ...
    axios.post(`https://reyda-medrec-project-api.herokuapp.com/api/v1/patient-records/${id}`, recordReq).then((response) => {
        ...
        <div className="row">
          ...
          <div className='col-10 card shadow'>
            <div className='row mt-3'>
              <h2 className='add-account-title-container col-4'>Add New Record</h2>
            </div>
            ...
            <div className='row d-flex justify-content-center'>
              ...
              <div className='row d-flex justify-content-center mt-3'>
                ...
                <div className='row'>
                  <div className="form-group col-12">
                    ...
                    <select className="form-select" aria-label="Default select example" autoComplete="off" defaultValue="Choose" name="labTest" onChange={onChange}>
                      <option value="Choose" disabled>Choose type of test</option>
                ...
                <div className='row'>
                  <div className="form-group col-12">
                    ...
                    <textarea type="text" className="form-control" placeholder='Input test result' autoComplete="off" name="result" onChange={onChange}/>
                  </div> 
                </div>
                ...
                <div className='row'>
                  <div className="form-group col-12">
                    ...
                    <textarea type="text" className="form-control" placeholder='Input findings' autoComplete="off" name="findings" onChange={onChange}/>
                  </div> 
                </div>
                ...
                <div className='row'>
                  <div className="form-group col-12">
                    ...
                    <textarea type="text" className="form-control" placeholder='Input advice' autoComplete="off" name="advice" onChange={onChange}/>
                  </div> 
                </div>
              </div>
              ...
              <div className='row mt-4 mb-4'>
                ...
                <button className="btn btn-primary col-2" onClick={submitRecord}>
        ...
        >
          <div>
            ...
            <div className='d-flex justify-content-center'>
              <button onClick={() => navigateToPatientsRecord()} className="btn btn-success">
