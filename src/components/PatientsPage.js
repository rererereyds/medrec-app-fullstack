...
const PatientsPage = () => {
  ...
  const getPatients = async () => {
    await axios.get(`https://reyda-medrec-project-api.herokuapp.com/api/v1/patients`).then((response) => {
        ...
        <div className='row'>
          ...
          <div className='row'>
            ...
            <div className='col-2 card border-0'>
              <button className='btn btn-primary' onClick={() => navigateToAddPatient()}>
