...
const LogIn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`https://reyda-medrec-project-api.herokuapp.com/api/v1/accounts/login`, loginDetails).then((response) => {
    ...
    <div>
      ...
      <div className='d-flex align-items-center'>
        ...
        <div className="col-sm-3 container me-5">
          ...
          <img src={require('../images/MedRec-login.png')} alt="logo and name"/>
            <h2 className="text-center mt-3 mb-4 text-primary">Log In</h2>
            <form onSubmit={(e) => handleSubmit(e)}>

                <div className="mb-3">
                    <label className="form-label">Username</label>
                    <input type="text" className="form-control border border-primary" id="exampleInputEmail1" autocomplete="off" value={accountUserName} onChange={(e) => setUserName(e.target.value)}/>
                </div>
                <div className="mb-3">
                    <label className="form-label">Password</label>
                    <input type="password" className="form-control border border-primary" id="exampleInputPassword1" value={accountPassword} onChange={(e) => setPassword(e.target.value)}/>
                </div>
                <div className="d-grid">
                    <button className="btn btn-primary" type="submit" onSubmit={(e) => handleSubmit(e)}>Login</button>
                </div>
            ...
            {login
              ...
              : <div className='row mt-5 mb-5'>Please input correct username and password.</div>
            }
        ...
        >
          <div>
            <p className='d-flex justify-content-center'>Oops! Cannot log in.</p>
            <p className='d-flex justify-content-center'>Wrong username or password.</p>
