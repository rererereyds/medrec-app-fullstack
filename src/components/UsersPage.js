...
const UsersPage = () => {
  ...
  const getUsers = async () => {
    await axios.get(`https://reyda-medrec-project-api.herokuapp.com/api/v1/accounts/active`).then((response) => {
        ...
        <div className='row'>
          <div className='col-1 card border-0'>
            <div className="dropdown show">
              <button className="btn btn-primary dropdown-toggle px-3" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-check-circle mb-1" viewBox="0 0 17 17">
