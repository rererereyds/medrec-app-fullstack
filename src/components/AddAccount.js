              ...
              <div className="row mt-4 mb-4">
                ...
                >
                  <svg
                    ...
                    height="16"
                    fill="white"
                    class="bi bi-file-earmark-plus d-inline mb-1"
                    viewBox="0 0 17 17"
                  >
        ...
        >
          <div>
            <p className="d-flex justify-content-center">
              Oops! Cannot create new account.
            </p>
            <p className="d-flex justify-content-center">
              Either this person already has an account or username already
              existed.
            </p>
