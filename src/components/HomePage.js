...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    axios.post(`https://reyda-medrec-project-api.herokuapp.com/api/v1/accounts/auth-user`, {token: localStorage.getItem("userToken")}).then((response) => {
          ...
          <div className='col-xl-9 card shadow ms-3'>
            ...
            <div className='row'>
              ...
              <div className='row mt-3'>
                <div className='col-8 ms-5 card d-inline'>
                  Graphs here.
                </div>
                  ...
                  <div>
                    ...
                    <div className='reminder-1 me-1'>
                      <div className='container-fluid d-flex justify-content-center align-items-center mt-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="blue" class="bi bi-keyboard-fill d-inline col-3 mb-3 me-2" viewBox="0 0 17 17">
                        ...
                        <p className='d-inline reminder-text'>Double check information before submitting new accounts or records.</p>
                      </div>
                    </div>
                    <div className='reminder-2 me-1'>
                      <div className='container-fluid d-flex justify-content-center align-items-center mt-2'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="blue" class="bi bi-lock d-inline col-3 mb-3 me-2" viewBox="0 0 17 17">
                        <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM5 8h6a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/>
                      </svg>
                        <p className='d-inline reminder-text'>Do not let anyone use your account to avoid data breach.</p>
                      </div>
                    </div>
                    <div className='reminder-3 me-1'>
                      <div className='container-fluid d-flex justify-content-center align-items-center mt-2'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="blue" class="bi bi-box-arrow-right d-inline col-3 mb-3 me-2" viewBox="0 0 17 17">
                        <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"/>
                        <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
                      </svg>
                        <p className='d-inline reminder-text'>Log out account after working hours or while taking breaks.</p>
                      </div>
                    </div>
                    <div className='reminder-4 me-1'>
                      <div className='container-fluid d-flex justify-content-center align-items-center mt-2'>
                        <p className="compliance-text">
                          These reminders are for the compliance to Joint Administrative Order No. 2016-002 entitled "Privacy Guidelines for the Implementation of the Philippine Health Information Exchange"
                        </p>
                      </div>
                    </div>
                  </div>
